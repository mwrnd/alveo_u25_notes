...
After enabling JTAG I was able to use UrJTAG to test pins A8 and A9. A8 connects to `PS_MIO22` (`AH32`) which is **RXD** and A9 connects to `PS_MIO23` (`AG35`) which is **TXD**.
